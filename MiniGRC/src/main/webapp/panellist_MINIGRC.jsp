					...
					<td colspan="2">
						<table border="1" cellpadding="10" width="60%">
							<thead bgcolor="B8D2FF">
								<tr>
									<th width="500p">Nom</th>
									<th width="250p">Creation e-mail</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach var="panel" items="${panelList}">
									<tr>
										<td><a
											href="createemail?selectedPanelId=${panel.panelId}">${panel.panelNom}</a>
										</td>
										<td><span class="nowrap"> <a
												href="createemail?selectedPanelId=${panel.panelId}">Creer
													un e-mail avec ce panel</a>
										</span></td>
									</tr>
								</c:forEach>
							</tbody>
